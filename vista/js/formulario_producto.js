jQuery(document).ready(function() {
    ...
    $("#btn").click(function() {
     ...
     var parametros={ id_categoria : _id_categoria , id_subcategoria: _id_subcategoria , id_proveedor : _id_proveedor , descripcion :_descripcion , v_costo : _v_costo , venta_ 1: _venta_1 ,venta_2 :_venta_2 , venta_3:_venta_3 , venta_4:_venta_4 ,p_utilidad:_p_utilidad , _stock_min:_stock_min, stock_max : _stock_max, medida : _medida, p_descuento : _p_descuento, observacion : _observacion };
