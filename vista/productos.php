  ...
  <div class="">
    ...
    <div class="contenido">
      ...
      <center>
       ...
       <select id="txtid_ubicacion" title="Se requiere una Ubicacion" required class="campos_edi">          

        <option value="" >Ubicacion</option>
        <option value="nueva_ubicacion">Nueva Ubicacion</option>
        ...
        foreach ($consulta as $registro) {
          ...
          <tbody>
            <tr>
              ...
              <?php
              require("php/p_ubicacion.php");
              ?>
              <td><?php echo $registro_6["descripcion"];?></td>
...
<div id="dialog-confirm_5" style="display:none;" title="Ubicacion">
  <div id="formulario">
    <form>
     <input type="text" value="1" hidden id="txtnueva" name="txtnueva">
     ...
     <br></br>              
     <label for="name">Descripcion:  </label>
     <textarea class="campo_des" id="txtdescripcion_ubi" name="txtdescripcion_ubi" rows="4" cols="48" placeholder="Descripcion"></textarea>
     <br></br> 
     <center>
      <input type="button" name="" value="Guardar" id="btn_ubi" class="btn">
    </center>
  </form>
</div>
</div>
