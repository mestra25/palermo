...
class categoriaDao {
    ...
    function guardar($Objcategoria){
            ...
            $consulta = $conexion->prepare('INSERT INTO ' . self::tabla . ' (descripcion,  observacion, fcreado, fmodificado,nueva) VALUES(:descripcion, :observacion, :fcreado, :fmodificado,:nueva)');
            $consulta->bindParam(':nueva', $Objcategoria->getnueva());
